...
import ar.utn.ba.dsi.servicioAgregador.models.dtos.AuthResponseDTO;
import ar.utn.ba.dsi.servicioAgregador.models.dtos.RefreshRequest;
import ar.utn.ba.dsi.servicioAgregador.models.dtos.TokenResponse;
import ar.utn.ba.dsi.servicioAgregador.models.dtos.UserRolesPermissionsDTO;
//import ar.utn.ba.dsi.servicioAgregador.services.LoginService;
...
/*@GetMapping("/user/roles-permisos")
  public ResponseEntity<UserRolesPermissionsDTO> getUserRolesAndPermissions(Authentication authentication) {
    try {
      ...
      log.error("Error al recuperar los roles y permisos del usuario", e);
